...
PhotonJet1 = isoPlotsFile.Get("PhotonJetIso1")
PhotonJet2 = isoPlotsFile.Get("PhotonJetIso2")
PhotonJet3 = isoPlotsFile.Get("PhotonJetIso3")
PhotonJet4 = isoPlotsFile.Get("PhotonJetIso4")
PhotonJet1.Rebin(2)
PhotonJet2.Rebin(2)
PhotonJet3.Rebin(2)
PhotonJet4.Rebin(2)
...
PhotonJetC.Write()
PhotonJetC.SaveAs("PhotonIsoPlot.pdf")
