...
MuonJet1 = isoPlotsFile.Get("MuonJetIso4overlapdR1")
MuonJet2 = isoPlotsFile.Get("MuonJetIso4overlapdR2")
MuonJet3 = isoPlotsFile.Get("MuonJetIso4overlapdR3")
MuonJet4 = isoPlotsFile.Get("MuonJetIso4overlapdR4")
MuonJet1.Rebin(2)
MuonJet2.Rebin(2)
MuonJet3.Rebin(2)
MuonJet4.Rebin(2)
...
outfile = TFile("MuondROutFile.root", "RECREATE")
MuonJetC.Write()
MuonJetC.SaveAs("MuondRPlot.pdf")
