...
ElectronJetC.cd()
isoPlotsFile = TFile("METvsMHTandSTdists.root")
ElectronJet1 = isoPlotsFile.Get("ElectronJetIso1")
ElectronJet2 = isoPlotsFile.Get("ElectronJetIso2")
ElectronJet3 = isoPlotsFile.Get("ElectronJetIso3")
ElectronJet4 = isoPlotsFile.Get("ElectronJetIso4")
...
outfile = TFile("EleIsoPlotsOutFile.root", "RECREATE")
ElectronJetC.Write()
ElectronJetC.SaveAs("ElectronIsoPlot.pdf")
